...
if(isset($_POST['btncreate'])){
    ...
    $insertdb = mysqli_query($db,"INSERT INTO test(username,password)VALUES('$username','$password')");
                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="form-group mt-4 mb-0">
                                                <button class="btn btn-primary btn-block" name="btncreate" href="login.php">
                                                    Create Account
                                                </button>
                                            </div>
                                        </form>
